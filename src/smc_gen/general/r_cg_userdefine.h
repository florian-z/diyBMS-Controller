...
#define CELL_MODULE_CHAIN_1 0
#define CELL_MODULE_CHAIN_2 1
#define CELL_MODULE_CHAIN_3 2
#define CELL_MODULE_CHAIN_4 3
...
#define SCI_TX_ZERO     0
#define SCI_TX_NO_ZERO  1
/* End user code. Do not edit comment generated here */
