...
__fast_interrupt static void r_Config_ICU_irq1_interrupt(void)
#else
__interrupt static void r_Config_ICU_irq1_interrupt(void)
#endif
{
...
__fast_interrupt static void r_Config_ICU_irq2_interrupt(void)
#else
__interrupt static void r_Config_ICU_irq2_interrupt(void)
#endif
{
