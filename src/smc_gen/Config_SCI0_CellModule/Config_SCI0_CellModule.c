...
/***********************************************************************************************************************
* File Name        : Config_SCI0_CellModule.c
...
/***********************************************************************************************************************
* Function Name: R_Config_SCI0_CellModule_Create
* Description  : This function initializes the SCI0 channel
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/

void R_Config_SCI0_CellModule_Create(void)
{
    ...
    SCI0.SEMR.BYTE = _04_SCI_BIT_MODULATION_ENABLE | _00_SCI_16_BASE_CLOCK | _00_SCI_NOISE_FILTER_DISABLE | 
    ...
    R_Config_SCI0_CellModule_Create_UserInit();
}

/***********************************************************************************************************************
* Function Name: R_Config_SCI0_CellModule_Start
* Description  : This function starts the SCI0 channel
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/

void R_Config_SCI0_CellModule_Start(void)
{
...
/***********************************************************************************************************************
* Function Name: R_Config_SCI0_CellModule_Stop
* Description  : This function stops the SCI0 channel
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/

void R_Config_SCI0_CellModule_Stop(void)
{
    /* Set TXD0 pin */
...
/***********************************************************************************************************************
* Function Name: R_Config_SCI0_CellModule_Serial_Receive
* Description  : This function receives SCI0data
* Arguments    : rx_buf -
...
MD_STATUS R_Config_SCI0_CellModule_Serial_Receive(uint8_t * const rx_buf, uint16_t rx_num)
{
...
/***********************************************************************************************************************
* Function Name: R_Config_SCI0_CellModule_Serial_Send
...
MD_STATUS R_Config_SCI0_CellModule_Serial_Send(uint8_t * const tx_buf, uint16_t tx_num)
{
    MD_STATUS status = MD_OK;
